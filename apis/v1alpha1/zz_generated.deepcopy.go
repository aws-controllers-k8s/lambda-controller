...
func (in *Environment) DeepCopyInto(out *Environment) {
	*out = *in
	...
	if in.VariablesFromSecretRefs != nil {
		in, out := &in.VariablesFromSecretRefs, &out.VariablesFromSecretRefs
		*out = make(map[string]*corev1alpha1.SecretKeyReference, len(*in))
		for key, val := range *in {
			var outVal *corev1alpha1.SecretKeyReference
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
