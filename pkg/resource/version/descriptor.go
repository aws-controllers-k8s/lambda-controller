...
const (
	finalizerString = "finalizers.lambda.services.k8s.aws/Version"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("versions")
