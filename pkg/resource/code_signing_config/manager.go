...
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=codesigningconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=codesigningconfigs/status,verbs=get;update;patch
