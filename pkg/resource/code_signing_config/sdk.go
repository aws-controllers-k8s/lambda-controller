...
func (rm *resourceManager) sdkFind(
	...
	if resp.CodeSigningConfig.AllowedPublishers != nil {
		...
		ko.Spec.AllowedPublishers = nil
	}
	if ko.Status.ACKResourceMetadata == nil {
		ko.Status.ACKResourceMetadata = &ackv1alpha1.ResourceMetadata{}
	}
	if resp.CodeSigningConfig.CodeSigningConfigArn != nil {
		arn := ackv1alpha1.AWSResourceName(*resp.CodeSigningConfig.CodeSigningConfigArn)
		ko.Status.ACKResourceMetadata.ARN = &arn
	}
	if resp.CodeSigningConfig.CodeSigningConfigId != nil {
		ko.Status.CodeSigningConfigID = resp.CodeSigningConfig.CodeSigningConfigId
	} else {
		ko.Status.CodeSigningConfigID = nil
	}
	if resp.CodeSigningConfig.CodeSigningPolicies != nil {
		...
		ko.Spec.CodeSigningPolicies = nil
	}
	if resp.CodeSigningConfig.Description != nil {
		ko.Spec.Description = resp.CodeSigningConfig.Description
	} else {
		ko.Spec.Description = nil
	}
	if resp.CodeSigningConfig.LastModified != nil {
		ko.Status.LastModified = resp.CodeSigningConfig.LastModified
	} else {
...
func (rm *resourceManager) newDescribeRequestPayload(
	r *resource,
) (*svcsdk.GetCodeSigningConfigInput, error) {
...
func (rm *resourceManager) newCreateRequestPayload(
	ctx context.Context,
	r *resource,
) (*svcsdk.CreateCodeSigningConfigInput, error) {
...
func (rm *resourceManager) newUpdateRequestPayload(
	ctx context.Context,
	r *resource,
) (*svcsdk.UpdateCodeSigningConfigInput, error) {
...
func (rm *resourceManager) newDeleteRequestPayload(
	r *resource,
) (*svcsdk.DeleteCodeSigningConfigInput, error) {
...
func (rm *resourceManager) setStatusDefaults(
	ko *svcapitypes.CodeSigningConfig,
) {
	if ko.Status.ACKResourceMetadata == nil {
		ko.Status.ACKResourceMetadata = &ackv1alpha1.ResourceMetadata{}
	}
