...
const (
	finalizerString = "finalizers.lambda.services.k8s.aws/FunctionURLConfig"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("functionurlconfigs")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.FunctionURLConfig{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.FunctionURLConfig),
	}
}
