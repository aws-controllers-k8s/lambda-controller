...
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=functionurlconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=functionurlconfigs/status,verbs=get;update;patch
