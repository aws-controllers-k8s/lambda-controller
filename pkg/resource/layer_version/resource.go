...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.LayerName = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["layerName"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: layerName"))
	}
	r.ko.Spec.LayerName = &primaryKey
