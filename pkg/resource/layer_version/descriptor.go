...
const (
	FinalizerString = "finalizers.lambda.services.k8s.aws/LayerVersion"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("layerversions")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.LayerVersion{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.LayerVersion),
	}
}
