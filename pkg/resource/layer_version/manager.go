...
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=layerversions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=layerversions/status,verbs=get;update;patch
